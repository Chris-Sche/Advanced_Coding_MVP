...
- Daily or weekly base of log returns? --> weekly
...
- Was sind Cali years (Zeile 119 dein Code) --> das sind dJohr wo brucht wärde um dCovariance matrix zerstelle fürs portfolio
- Was genau machen die Portfolioformeln um Zeile 211-225 (dein code)? =  ergänze das im Markdown um Zeile 263
- Was macht reb_int in der Funktion Zeile 232 (dein Code)? --> Definiert wie oft sPortfolio rebalanced wird (wenn i dini Frog richtig verstande)
